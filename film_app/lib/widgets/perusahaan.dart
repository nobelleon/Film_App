import 'package:film_app/bloc/get_actor_bloc.dart';
import 'package:film_app/model/pemeran.dart';
...
class Perusahaan extends StatefulWidget {
  ...
  const Perusahaan({Key key, this.id}) : super(key: key);

  @override
  _PerusahaanState createState() => _PerusahaanState(id);
}

class _PerusahaanState extends State<Perusahaan> {
  final int id;

  _PerusahaanState(this.id);
