...
import 'package:film_app/bloc/get_films_list_bloc.dart';
...
class FilmTerbaik extends StatefulWidget {
  @override
  _FilmTerbaikState createState() => _FilmTerbaikState();
}

class _FilmTerbaikState extends State<FilmTerbaik> {
  @override
  void initState() {
    super.initState();
    filmsListBloc..getFilms();
  }
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        StreamBuilder<ResponFilm>(
          stream: filmsListBloc.subject.stream,
          builder: (context, AsyncSnapshot<ResponFilm> snapshot) {
            if (snapshot.hasData) {
              ...
              return _bangunWidgetFilmTerbaik(snapshot.data);
  ...
  // widget Film Terbaik
  Widget _bangunWidgetFilmTerbaik(ResponFilm data) {
